...
function PricePercentButtons({ intraday, symbol, userCash, userPosition, tickerInfo, history }) {
   ...
   return (
      <div className="price_btn-wrapper">
         ...
         <div className="btn-wrapper">
            <BuyButton open={open} symbol={symbol} userCash={userCash} tickerInfo={tickerInfo} history={history} percent={percent}/>
            <SellButton open={open} symbol={symbol} userPosition={userPosition} tickerInfo={tickerInfo} history={history} percent={percent}/>
         </div>
      </div>
   )
}
